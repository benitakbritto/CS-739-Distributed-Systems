/*
https://github.com/google/snappy/blob/main/README.md
Usage: snappy_test_tool <name_of_file_to_be_compressed>
*/
...
int main(int argc, char** argv) {
  ...
  snappy::CompressFile(argv[1]);
  clock_gettime(CLOCK_TYPE, &stop);

  std::cout<< "Compression time: "<< (stop.tv_sec - start.tv_sec) <<" s "
